...
/* Tayyab Ilyas 23-04-2024 (// use to comment on JS) */
// I make a programg that remove white spaces .
var withSpace = "          Tayyab ilyas    "; //  with sapce
var withOutSpace = withSpace.trim(); // use .trim() can remove all white spaces.
console.log("".concat(withSpace, " with spaces"));
console.log("".concat(withOutSpace, " with out spaces \n      Task Completed"));
